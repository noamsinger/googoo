...
public class InstructionsState extends GameState {
    ...
    private static final String[] INSTRUCTIONS = {
            ...
            "",
            "Shield Mode:",
            "  Start with 100% shield energy.",
            "  Collisions deal 1-10% damage based on impact speed.",
            ...
            "  Starships: Faster and more agile ships",
            "  Fire Modes: Manual → Semi-Auto → Auto → Vulkan",
            "  Weapons: Bullet (standard) or Torpedo (homing)",
            "  Shields: Hit Shield (absorbs hits) or Timed Shield",
            "  Lives Mode: Buy extra lives (10 EXP each)",
            "  Shield Mode: Restore 5% shield (5 EXP each)",
            "",
            "",
            "=== LEVEL PROGRESSION ===",
            "",
